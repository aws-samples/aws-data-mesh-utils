...
class Step3_5():
    ...
    def modify_access_permissions(self, subscription_id: str, grant_permissions: list, grantable_permissions: list,
                                  approval_notes: str):
        # modify the grants given from the producer
        approval = self._mgr.update_subscription_permissions(
...
if __name__ == "__main__":
    ...
    print(Step3_5().modify_access_permissions(subscription_id=args.subscription_id,
